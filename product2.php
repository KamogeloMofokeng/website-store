         ...
         <div class="nav">
           <li><a href="T&C.php">T & C's</a></li>
            ...
            <h1>Simplistic Threads</h1>
                ...
                <center>
                <div class="gallery">
                    <img src="pictures/OIP (9).jpg" height="270px" width="290px"><br><br>
                    <h3>emerald green sofa</h3><br>
                    <span><p>This emerald green style couch is a hand crafted couch made in South Africa </p></span><br>
                    <h3>R10 000</h3>
                    <div class="button">
